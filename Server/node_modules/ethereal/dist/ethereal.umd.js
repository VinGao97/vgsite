(function (global, factory) {
  ...
  (factory((global.ethereal = {}),global.three));
}(this, (function (exports,THREE) {
  var V_00 = Object.freeze(new THREE.Vector2());
  var V_11 = Object.freeze(new THREE.Vector2());
  var V_000 = Object.freeze(new THREE.Vector3());
  var V_100 = Object.freeze(new THREE.Vector3(1, 0, 0));
  var V_010 = Object.freeze(new THREE.Vector3(0, 1, 0));
  var V_001 = Object.freeze(new THREE.Vector3(0, 0, 1));
  var V_111 = Object.freeze(new THREE.Vector3(1, 1, 1));
  var Q_IDENTITY = Object.freeze(new THREE.Quaternion());
  ...
  var vectors2 = new Pool(function () { return new THREE.Vector2(); }, function (vec) { return vec.set(0, 0); });
  var vectors = new Pool(function () { return new THREE.Vector3(); }, function (vec) { return vec.set(0, 0, 0); });
  var vectors4 = new Pool(function () { return new THREE.Vector4(); }, function (vec) { return vec.set(0, 0, 0, 1); });
  var quaternions = new Pool(function () { return new THREE.Quaternion(); }, function (quat) { return quat.set(0, 0, 0, 1); });
  var matrices3 = new Pool(function () { return new THREE.Matrix3(); }, function (mat) { return mat.identity(); });
  var matrices = new Pool(function () { return new THREE.Matrix4(); }, function (mat) { return mat.identity(); });
  ...
  }(THREE.Geometry)); // ConvexBufferGeometry
  ...
  SimplifiedHull.compute = function compute (geometry, maxPoints) {
    ...
    var normalGeometry = bufferGeometry ? new THREE.Geometry().fromBufferGeometry(bufferGeometry) : geometry;
  ...
  var Box3 = /*@__PURE__*/(function (superclass) {
    function Box3() {
    ...
    if ( superclass ) Box3.__proto__ = superclass;
    Box3.prototype = Object.create( superclass && superclass.prototype );
    Box3.prototype.constructor = Box3;

    Box3.prototype._onObjectTraverse = function _onObjectTraverse (node) {
    ...
    Box3.prototype.expandByObjectGeometry = function expandByObjectGeometry (node) {
      var i, l;
    ...
    Box3.prototype.expandByObjectHull = function expandByObjectHull (node) {
      var mesh = node;
      var vector = this._vector;
      var geometry = mesh.geometry;
    ...
    Box3.prototype.expandByObjectBox = function expandByObjectBox (node) {
      var box = this._box;
      var mesh = node;
      var geometry = mesh.geometry;
      if (!geometry) { return this; }
    ...
    Box3.prototype._getCoordinateSystemTransform = function _getCoordinateSystemTransform (node) {
      var mat4 = this._mat4;
    ...
    Box3.prototype.relativeToAbsolute = function relativeToAbsolute (relativePosition, out) {
    ...
    Box3.prototype.absoluteToRelative = function absoluteToRelative (absolutePosition, out) {
  ...
  var rotateY180 = new THREE.Quaternion().setFromAxisAngle(V_010, Math.PI);
  /**
  ...
  var VisualFrustum = function VisualFrustum(coordinateSystem) {
    ...
    this.minClamped = new THREE.Vector3();
    this.maxClamped = new THREE.Vector3();
    this._vec3 = new THREE.Vector3();
    this._mat4 = new THREE.Matrix4();
    this._boxPoints = [new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3()];
  };
  ...
  SpatialMetrics.getCartesianForSphericalDirection = function getCartesianForSphericalDirection (sphericalDirection, out) {
    var visualElevationRadians = THREE.Math.DEG2RAD * sphericalDirection.y;
    var visualAzimuthRadians = THREE.Math.DEG2RAD * sphericalDirection.x;
  ...
  SpatialMetrics.prototype.getVisualOffsetOf = function getVisualOffsetOf (target) {
    ...
    var result = V_001.angleTo(direction) * THREE.Math.RAD2DEG;
    vectors.pool(direction);
    return result;
  };
  ...
  var directions = [new THREE.Vector3(1, 0, 0), new THREE.Vector3(0, 1, 0), new THREE.Vector3(0, 0, 1), new THREE.Vector3(-1, 0, 0), new THREE.Vector3(0, -1, 0), new THREE.Vector3(0, 0, -1)]; // export function getMetrics(obj: THREE.Object3D) : SpatialMetrics {
  ...
  var Layout = function Layout(object) {
    ...
    this.minRelativeSize = new THREE.Vector3();
    /**
     *
     */

    this.minAbsoluteSize = new THREE.Vector3();
    this._fit = 'contain';
    /** Used internally. */
    ...
    this.fitAlign = new THREE.Vector3();
    this.clip = new Box3();
    this.inner = new Box3();
    this.innerAutoUpdate = true;
    this.computedBounds = new Box3();
    this.computedInnerBounds = new Box3();
    this.computedOuterBounds = new Box3();
    this.computedClipBounds = new Box3();
  ...
  */
  ...
  Layout._fitScale = new THREE.Vector3(); // function isNaN(a:number) {
  //     return a !== a
  // }
  ...
  Transitionable.prototype._addTargetInfluence = function _addTargetInfluence (start, target) {
    ...
    if (typeof target.value === 'number') {
      this.current += THREE.Math.lerp(0, target.value - start, alpha);
      return;
    }
  ...
  Transitionable._c = new THREE.Color();
  Transitionable._cBlack = new THREE.Color(0, 0, 0);
  ...
  var Transitioner = function Transitioner(object) {
    ...
    this.matrixWorldTarget = new THREE.Matrix4();
    /**
     * A multiplier to influence the speed of the transition
     */
      ...
      if (typeof t.path === 'string') {
        ...
        for (var i = 0, list = t.path; i < list.length; i += 1) {
          var p = list[i];
            ...
            if (property$1) { property$1.copy(t.current); }
          }
        }
      }
    }
  ...
  THREE.Object3D.prototype.updateWorldMatrix = function (updateParents, updateChildren, updateLayout) {
  ...
  var LayoutHelper = /*@__PURE__*/(function (superclass) {
    function LayoutHelper() {
      superclass.call(this);
      this._transitional = new THREE.Object3D();
      this._transitionalBoxHelper = new THREE.Box3Helper(this._transitional.layout.inner);
      this._target = new THREE.Object3D();
      this._targetBoxHelper = new THREE.Box3Helper(this._target.layout.inner);
